(function ( $ ){
	...
	EXAMPLE CONFIGURATION
		...
		dataDuration	= '90days', // Default duration of data to be displayed // ref: 
	...
	*/
	...
	var defaultKey		= 'OaJSySJ1Wyl9PnSNiO3nIf9C5zydiuCVCbtafNi1tPIppfeZ', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1341302811], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Katla Monitor', // Replaces Xively logo in the header
			...
			if(feedData.datastreams) {
				...
				feedData.datastreams.forEach(function(datastream) {
					...
					if(duration == '6hours') diff = 21600000;
					 if(duration == '12hours') diff = 43200000;
